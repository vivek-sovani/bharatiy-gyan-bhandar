...
export const LIVING_KNOWLEDGE: Gift[] = [
  ...
  },
  {
    ...
    what: `The āśrama system divides the ideal human lifespan into four sequential stages, each with its own purpose: brahmacarya (the student stage, devoted to learning and discipline), gṛhastha (the householder stage, devoted to family, work, and social contribution), vānaprastha (the forest-dweller stage of gradual withdrawal and mentoring), and saṃnyāsa (the renunciate stage, devoted to spiritual freedom). It maps the puruṣārthas onto a lifetime, assigning different priorities to different ages.`,
    when: `The four-stage scheme is set out in the Dharmaśāstra literature and the later Upaniṣads, taking classical form across the first millennium BCE and the early centuries CE. It became the normative template for the well-ordered life in classical Indian society.`,
    how: `The āśrama system is one of the world's earliest explicit frameworks for life-stage planning, anticipating the idea in modern developmental psychology — as in Erik Erikson's stages — that different phases of life carry different tasks and priorities. Its sequencing of education, then productive householder life, then a gradual letting-go and turn toward meaning speaks directly to contemporary conversations about career arcs, mid-life transition, 'second acts', and conscious ageing.`,
  },
  {
    id: 'dharma-ethics',
    n: 70,
