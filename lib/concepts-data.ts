...
export const CONCEPTS: Concept[] = [
...

  {
    ...
    source: 'Dharmaśāstra',
    sourceDeva: 'धर्मशास्त्र',
    blurb: 'The moral credit and moral debt accrued by action. Every deed that violates dharma deposits pāpa; every deed that upholds it deposits puṇya. Together they drive the wheel of saṃsāra.',
    tags: ['Sin', 'Merit', 'Karma'],
    detail: {
      intro: 'Pāpa and puṇya are the negative and positive moral weights that action deposits in the doer. Pāpa — translated variously as sin, evil, demerit — is the residue of actions that violate dharma, harm living beings or pollute ritual and social order. Puṇya is the opposite: the merit won by right conduct, generosity, worship and study. Together they are the moral currency of saṃsāra.',
      aspects: [
        'Unlike the Western concept of sin, pāpa is not primarily a broken relationship with God but an objective moral weight — a contamination or deficit that bears consequences of its own accord through the law of karma.',
        'Puṇya accumulated through ritual, dāna, pilgrimage, fasting and service can offset pāpa; at its limit, a life of pure puṇya leads to higher birth or svarga (heaven).',
        'The Mīmāṃsā school analysed pāpa and puṇya with precision: Vedic injunctions (vidhi) generate puṇya; prohibitions (niṣedha) mark the boundary whose crossing creates pāpa.',
      ],
      significance: 'The pāpa–puṇya framework makes karma morally legible: actions have a trackable weight that shapes future experience. Yet the tradition is careful — accumulating puṇya still keeps one in saṃsāra; mokṣa requires transcending both, since even merit is a golden fetter. Prāyaścitta (expiation) and niṣkāma-karma both aim at a life beyond the credit ledger altogether.',
      origin: {
        label: 'Dharmaśāstra',
        href: '/darshanas/',
        explainer: 'The Dharmasūtras and Smṛtis (Manu, Yājñavalkya) codify a dense taxonomy of pāpa-producing acts — ritual impurity, violence, theft, falsehood, breach of caste duty — and prescribe the puṇya-generating remedies. The scheme is deeply woven into the householder\'s moral world: daily rites generate steady puṇya; transgressions require prāyaścitta to neutralise accumulated pāpa. The legal-textual tradition treats the pāpa–puṇya account as the invisible balance sheet that dharmic life is designed to manage.',
      },
      references: [
        {
          label: 'Bhagavad Gītā & transcendence of merit',
          href: '/itihasa/',
          explainer: 'The Gītā\'s teaching cuts across the pāpa–puṇya framework. Kṛṣṇa tells Arjuna that one who performs niṣkāma-karma — action without attachment to its fruit — is neither stained by pāpa nor bound by puṇya: "As a lotus leaf is untouched by water, so the one who acts without attachment is untouched by sin." The highest freedom is freedom from the moral ledger itself, not merely a favourable balance on it. This move reconfigures pāpa and puṇya from ultimate categories into provisional ones: relevant within the world of dharmic conduct, but dissolved at the level of liberation.',
        },
      ],
    },
  },
  {
    ...
    deva: 'प्रायश्चित्त',
    seal: 'प्र',
    gloss: 'Expiation · atonement',
    glossDeva: 'प्रायश्चित्त · परिहार',
    domain: 'ethics',
    source: 'Dharmaśāstra',
    sourceDeva: 'धर्मशास्त्र',
    blurb: 'The rites and disciplines by which accumulated pāpa is neutralised and moral equilibrium restored. From fasting to pilgrimage to a lifetime of service — the tradition\'s science of repair.',
    tags: ['Atonement', 'Purity', 'Dharmaśāstra'],
    detail: {
      intro: 'Prāyaścitta — expiation or atonement — is the body of practices prescribed to neutralise pāpa (moral demerit) and restore a person to ritual purity and dharmic standing. Where pāpa is the wound, prāyaścitta is the medicine: a calibrated response matched to the gravity of the transgression.',
      aspects: [
        'Prescriptions range in severity with the offence: minor transgressions call for fasting, bathing and mantra recitation; grave ones (killing a brahmin, breaking a vow of celibacy) require elaborate multi-year penances or pilgrimages to tīrthas.',
        'The mechanism is not merely symbolic — Mīmāṃsā treats prāyaścitta as generating actual puṇya that offsets accumulated pāpa, restoring the karmic balance of the doer.',
        'Inner contrition (śocana, remorse) is recognised as a precondition: the rites work on the assumption of sincere acknowledgement of wrong. A prāyaścitta performed cynically, intending to sin again, is declared ineffective.',
      ],
      significance: 'Prāyaścitta gives the dharmic order a theory of repair: no transgression places one permanently beyond recovery, and the community\'s moral fabric can be rewoven. It also creates a diagnostic literature — the Dharmaśāstras classify offences, grade their pāpa and prescribe remedies with a detail that amounts to a moral casuistry. The institution acknowledges human fallibility while insisting that moral consequences are real and must be actively discharged.',
      origin: {
        label: 'Dharmaśāstra',
        href: '/darshanas/',
        explainer: 'The Āpastamba and Gautama Dharmasūtras are among the earliest texts to systematise prāyaścitta, listing penances for ritual impurity, dietary transgressions and caste violations. Manu\'s Smṛti devotes two chapters to the topic, organising offences into mahāpātakas (deadly sins: brahmin-murder, drinking sura, theft of gold, violating the guru\'s bed) and lesser transgressions (upapātakas), and prescribing graduated remedies. The detailed grid of offence-and-remedy became a benchmark for later texts and was practically administered by dharma-paṇḍitas who adjudicated cases and prescribed penances.',
      },
      references: [
        {
          label: 'Bhakti & inner atonement',
          href: '/itihasa/',
          explainer: 'The bhakti tradition reoriented prāyaścitta from external rite to inner transformation. The Bhāgavata Purāṇa famously argues that mere prāyaścitta without genuine turning of the heart is like a bath that leaves the mind dirty: "The elephant cleanses itself in water, then rolls in the dust again." True expiation is a change of orientation — devotion, surrender, and the name of the Lord burn pāpa at its root. This interiorisation did not eliminate ritual prāyaścitta but placed it within a larger vision in which inner conversion, not correct performance, is the real work.',
        },
      ],
    },
  },
  {
    ...
    deva: 'दण्ड',
    seal: 'द',
    gloss: 'Punishment · rod of order',
    glossDeva: 'दण्ड · शासन',
    domain: 'ethics',
    source: 'Arthaśāstra · Dharmaśāstra',
    sourceDeva: 'अर्थशास्त्र · धर्मशास्त्र',
    blurb: 'The rod of royal authority and the principle of legitimate coercive force. Without daṇḍa, the world falls into matsya-nyāya — the law of the fish, where the strong devour the weak.',
    tags: ['Punishment', 'Authority', 'Rājanīti'],
    href: '/darshanas/',
    detail: {
      intro: 'Daṇḍa — the rod, staff, or staff of punishment — names both the physical instrument of royal force and the principle that legitimate coercive power is the pillar on which social order rests. In political philosophy it is one of the four means (upāyas) a king deploys: conciliation, gift, division of enemies, and finally daṇḍa. Without it, dharma itself would be unenforceable.',
      aspects: [
        'Matsya-nyāya — "the justice of fish," in which large fish eat smaller ones — is the catastrophic state without daṇḍa. The king\'s rod is the only thing that stands between dharmic order and predatory chaos.',
        'Daṇḍa must be wielded with discrimination (viveka): Kauṭilya insists the king who punishes the innocent or inflicts disproportionate penalties destroys popular trust; the king who fails to punish the guilty invites disorder.',
        'The Dharmaśāstras treat daṇḍa as itself dharmic: punishing a wrongdoer purges the offender\'s pāpa and upholds the moral order — so the king who enforces dharma through punishment is performing a cosmic function.',
      ],
      significance: 'Daṇḍa is Indian political thought\'s honest acknowledgement that social order requires force as well as consent. Kauṭilya\'s Arthaśāstra turns this into a rigorous science of statecraft; the Dharmaśāstras root it in cosmic necessity. The concept also bridges politics and ethics: right punishment is itself a form of dharma, not merely a suspension of it. It anticipates modern debates about legitimacy of coercion and the state\'s monopoly on violence.',
      origin: {
        label: 'Arthaśāstra (Kauṭilya)',
        href: '/darshanas/',
        explainer: 'Kauṭilya\'s Arthaśāstra (c. 3rd century BCE – 3rd century CE) gives the most systematic analysis of daṇḍa in the tradition. It opens with the claim that artha (material well-being of the state) is the foundation of all the other aims of life — and daṇḍa is its instrument of protection. Kauṭilya classifies punishments in fine detail: capital punishment, mutilation, fines, and public humiliation, calibrated by the gravity of the offence and the status of offender and victim. The treatise is also keenly aware of the dangers of misapplied daṇḍa and devotes considerable space to how a king can maintain just, moderate, and consistent enforcement.',
      },
      references: [
        {
          label: 'Mahābhārata (Śāntiparvan)',
          href: '/itihasa/',
          explainer: 'The Śāntiparvan of the Mahābhārata contains extended meditations on daṇḍa through the dying Bhīṣma\'s instruction to Yudhiṣṭhira. The text wrestles with the paradox: daṇḍa is violent, yet necessary; to renounce all force out of compassion is itself a form of injustice toward the weak. Yudhiṣṭhira\'s reluctance to rule — his desire to take sannyāsa rather than govern — is precisely the temptation the Śāntiparvan warns against. The cosmos depends on the willingness of the righteous to wield the rod.',
        },
      ],
    },
  },
  {
    ...
    glossDeva: 'श्रद्धा · विश्वास',
    domain: 'ethics',
    source: 'Upaniṣads · Bhagavad Gītā',
    sourceDeva: 'उपनिषदे · भगवद्गीता',
    blurb: 'Not blind belief but the trustful orientation of the whole person — toward the teacher, the teaching, the self, and the real. The indispensable disposition without which knowledge cannot take root.',
    tags: ['Faith', 'Trust', 'Receptivity'],
    href: '/upanishads/',
    detail: {
      intro: 'Śraddhā is the Sanskrit term for faith, but it denotes something richer than belief in propositions: it is the orientation of the whole person — intellectual, emotional, and volitional — toward what is true, toward the teacher who can transmit it, and toward the self that is capable of realising it. It is the necessary soil in which teaching takes root.',
      aspects: [
        'Distinguished from mere credulity (viśvāsa based on rumour) and from logical proof: śraddhā is the earned trust that opens the pupil to receive what cannot yet be demonstrated from within their current understanding.',
        'The Bhagavad Gītā classifies śraddhā by the three guṇas: sāttvika śraddhā is directed toward wisdom and liberation; rājasa śraddhā toward power and pleasure; tāmasa śraddhā toward dark rites and delusion.',
        'The Taittirīya Upaniṣad names it as one of the indispensable virtues to be lived: "śraddhayā deyam" — give with faith, give with sensitivity, give with humility.',
      ],
      significance: 'Śraddhā bridges the epistemological gap between where the student stands and where the teaching points. In the guru–śiṣya relationship, without śraddhā the teaching cannot be transmitted: the pupil\'s mind stays closed. In the wider tradition, śraddhā is what sustains practice before results are felt, and what prevents the seeker from abandoning the path at its hardest point. It is neither passive acceptance nor intellectual surrender but an active, discerning trust.',
      origin: {
        label: 'Upaniṣads',
        href: '/upanishads/',
        explainer: 'Śraddhā appears early and centrally in the Upaniṣadic setting of teaching. The Chāndogya and Taittirīya present it as a prerequisite the student brings to the teacher: without it, the teaching cannot cross. The Kaṭha Upaniṣad dramatises this — the young Naciketas approaches Yama with śraddhā, steadiness and restraint, and it is precisely this combination that makes him worthy of the teaching on death and the self. The Taittirīya includes śraddhā in its list of qualities to be cultivated: "speak the truth, follow dharma, devote yourself to study, do not neglect śraddhā" — placing it alongside the other foundational virtues.',
      },
      references: [
        {
          label: 'Bhagavad Gītā',
          href: '/itihasa/',
          explainer: 'Chapter 17 of the Gītā opens with Arjuna\'s question about those who worship with faith but without scriptural authority. Kṛṣṇa\'s answer makes śraddhā central to the whole taxonomy of human types: "The faith of each person is made of their own nature" (sattvanurūpā sarvasya śraddhā bhavati). The three-fold division by guṇa shows śraddhā as neither uniformly positive nor automatically salvific — it can be directed toward darkness as easily as toward light. What makes it transformative is its sāttvika form: a faith that is clear-eyed, open to the real, and properly directed toward the highest good.',
        },
      ],
    },
  },
  {
    ...
    seal: 'दा',
    gloss: 'Giving · gift',
    glossDeva: 'दान · उदारता',
    domain: 'ethics',
    source: 'Dharmaśāstra · Bhagavad Gītā',
    sourceDeva: 'धर्मशास्त्र · भगवद्गीता',
    blurb: 'Giving as a fundamental act of dharmic life — not charity as optional generosity but as the basic counter-movement to the ego\'s natural hoarding. One of the three pillars of ethical life across every Indian school.',
    tags: ['Generosity', 'Virtue', 'Non-attachment'],
    detail: {
      intro: 'Dāna — giving, gift, generosity — is treated across the entire Indian tradition as one of the foundational acts of a good life. It is not an occasional extra but a basic discipline: the structured release of attachment to one\'s own resources in favour of another\'s need or a higher purpose. The tradition analyses its conditions, motives, recipients and fruits with the same precision it brings to ritual.',
      aspects: [
        'Valid dāna requires three elements: a worthy recipient (pātra), the right mental attitude in the giver (śraddhā, not condescension), and goods honestly obtained — dāna of stolen goods produces no puṇya.',
        'Recipients are graded in the tradition: dāna to a learned brahmin who will use the gift for study and teaching generates the highest puṇya; but across the schools, dāna to the poor, the sick and wandering ascetics is also highly valued.',
        'The Gītā\'s typology applies: sāttvika dāna is given to the right person, at the right time and place, without expectation of return; rājasa dāna is given for prestige or hoping for reciprocal gifts; tāmasa dāna is given contemptuously or in the wrong time and place.',
      ],
      significance: 'Dāna is the tradition\'s practical counter to the grasping tendency (lobha) that generates karma. By deliberately giving away, one loosens the ego\'s identification with "mine" — the same movement that makes niṣkāma-karma possible. Across Hindu, Buddhist and Jaina traditions, dāna is the first and most accessible of the virtues: even a householder with no access to advanced practice can begin the inner work of non-attachment through daily giving.',
      origin: {
        label: 'Dharmaśāstra',
        href: '/darshanas/',
        explainer: 'The Dharmaśāstras devote extensive sections to dāna-dharma: the classification of gifts (land, cattle, gold, food, knowledge), the qualifications of worthy recipients, the proper occasions (eclipses, festivals, tīrthas, death anniversaries) and the sins of taking back a gift. Gifts of knowledge (vidyā-dāna) and food (anna-dāna) are consistently ranked highest. The entire institution of supporting brāhmaṇa-scholars through gift is underpinned by this framework — the educated class was, in principle, the class supported by the dāna of the producing classes in exchange for ritual and learning.',
      },
      references: [
        {
          label: 'Buddhist dāna & the pāramitās',
          href: '/darshanas/',
          explainer: 'In the Buddhist tradition, dāna is the first of the ten pāramitās (perfections) cultivated on the bodhisattva path, and the first of the three pillars of lay practice alongside śīla (virtue) and bhāvanā (meditation). The giving is extended progressively — from material goods, to protection from fear, to the ultimate gift of Dhamma. The Jātaka tales dramatise dāna brought to its extreme: the bodhisattva in past lives gives away not just wealth but eyes, limbs and life itself. This intensification makes dāna the seed of the bodhisattva ideal: the radical generosity that dissolves the boundary between self and other.',
        },
      ],
    },
  },
  {
    ...
    deva: 'वर्ण',
    seal: 'व',
    gloss: 'Social order · class',
    glossDeva: 'वर्ण · सामाजिक वर्गीकरण',
    domain: 'ethics',
    source: 'Ṛgveda · Dharmaśāstra',
    sourceDeva: 'ऋग्वेद · धर्मशास्त्र',
    blurb: 'The four-fold ordering of society into brahmin, kṣatriya, vaiśya and śūdra — originally a functional taxonomy, later a hereditary structure, and perennially a source of both social cohesion and injustice.',
    tags: ['Society', 'Duty', 'Order'],
    detail: {
      intro: 'Varṇa — literally "colour" or "category" — names the four-fold division of society into brāhmaṇas (scholars and priests), kṣatriyas (warriors and rulers), vaiśyas (traders and farmers) and śūdras (those who serve). It is the oldest framework through which the tradition thought about social order, specialisation of function, and the duties appropriate to one\'s station. Its origins are cosmological; its historical reality was deeply complex, contested, and — in the form of hereditary caste — the ground of much human suffering.',
      aspects: [
        'The Puruṣasūkta (Ṛgveda X.90) derives the four varṇas from the cosmic sacrifice of the primeval Person: brāhmaṇas from the mouth, kṣatriyas from the arms, vaiśyas from the thighs, śūdras from the feet — a cosmological grounding that ties the social order to the structure of the universe itself.',
        'The Bhagavad Gītā reinterprets varṇa functionally: "The four-fold varṇa was created by me according to the divisions of guṇa and karma" — making it a classification by natural quality and activity, not birth. This opened a critical tradition that separated the ideal (guṇa-karma-based) from the actual (birth-based jāti).',
        'The tradition always recognised the gap between varṇa (the ideal four-fold scheme) and jāti (the thousands of endogamous birth-communities that were the lived social reality). Critics — from the Buddha to the bhakti saints to Ambedkar — argued the system was not merely imperfectly implemented but structurally unjust.',
      ],
      significance: 'Varṇa is perhaps the most contested concept in the entire tradition. It encodes a vision of functional specialisation and social interdependence that its defenders treat as a form of cosmic order; its critics — across two and a half millennia — see in it the ideological armature of hereditary privilege and systematic exclusion. Understanding it is essential for any serious engagement with Indian ethical, social and political thought — and the tradition\'s own internal debate about it is among the richest it produced.',
      origin: {
        label: 'Ṛgveda (Puruṣasūkta)',
        href: '/vedas/',
        explainer: 'The Puruṣasūkta (Ṛgveda X.90) is the locus classicus of varṇa: the hymn of the cosmic Person whose sacrifice generates the universe. The four varṇas emerge from different parts of the body — an image that makes them both distinct and parts of one whole. The hymn does not specify hereditary transmission; it presents the fourfold as the structure through which cosmic and social order is maintained. This cosmological grounding gave the scheme enormous authority — and made its later hereditary form very difficult to challenge from within the tradition, since to question birth-based varṇa seemed to question the order of the cosmos itself.',
      },
      references: [
        {
          label: 'Bhagavad Gītā & Ambedkar\'s critique',
          href: '/itihasa/',
          explainer: 'The Gītā\'s verse (IV.13) — "cāturvarṇyam mayā sṛṣṭaṃ guṇa-karma-vibhāgaśaḥ" — became the central text in the debate between defenders of the system and reformers. Tilak read it as grounding varṇa in birth; Gandhi read it as making a guṇa-and-karma-based varṇa both valid and compatible with social reform; Ambedkar rejected the entire framework as irredeemably hierarchical, arguing in "Annihilation of Caste" that the Gītā could not be rescued from its complicity with the caste order. The debate is unresolved and live: it dramatises the tension between the tradition\'s idealist self-understanding and the material reality of exclusion the system enforced.',
        },
      ],
    },
  },
