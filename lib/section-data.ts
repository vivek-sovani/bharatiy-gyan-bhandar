    ...
    items: [
      {
        ...
        aspects: [
          { name: 'Brāhma muhūrta', deva: 'ब्राह्म मुहूर्त', desc: 'The ninety-six minutes before sunrise — the hour when sattva is highest in the atmosphere and the mind takes its colour from the day to come. Recommended for waking, bathing and contemplative practice.' },
          { name: 'Abhyaṅga', deva: 'अभ्यङ्ग', desc: 'Self-oil massage with warm sesame or coconut, performed before the bath. The skin is treated as an absorptive organ; the daily lubrication is the single most-recommended intervention in Caraka’s opening sūtra.' },
          { name: 'Madhyāhna-bhojana', deva: 'मध्याह्न-भोजन', desc: 'The principal meal taken between 10 a.m. and 2 p.m., when Pitta — the digestive fire — is at its strongest. The body cannot fully process a heavy meal taken later in the day.' },
          { name: 'Pradoṣa-kāla', deva: 'प्रदोष-काल', desc: 'The transition window at dusk — light food, the senses gradually withdrawn, no heavy mental work. The night’s sleep is built in the hour before sundown.' },
        ],
      },
      {
      ...
      },
      {
        ...
        aspects: [
          { name: 'Brahmacarya', deva: 'ब्रह्मचर्य', desc: 'The student stage. Years 0–25 in the ideal scheme. Study under a guru, mastery of the Veda or the chosen śāstra, celibacy, and the cultivation of disciplines (vrata) that the householder stage will need.' },
          { name: 'Gārhasthya', deva: 'गार्हस्थ्य', desc: 'The householder stage. Years 25–50. Marriage, the raising of children, the running of a household, the practice of artha and kāma within the frame of dharma. The single stage on which the other three depend, materially.' },
          { name: 'Vānaprastha', deva: 'वानप्रस्थ', desc: 'The forest-dweller stage. Years 50–75. The household is handed over to the next generation; the person withdraws gradually from public life, takes up deeper contemplative practice, and prepares for the final renunciation.' },
          { name: 'Sannyāsa', deva: 'संन्यास', desc: 'The renunciate stage. Years 75 onward (and, optionally, earlier). All property, status and family attachment are given up. The single remaining puruṣārtha is mokṣa.' },
        ],
      },
      {
